...
`new issue <https://github.com/NERC-CEH/isoperiod/issues>`_.
...
We use GitHub issues to track suggested enhancements to isoperiod.
You can suggest an enhancement by opening a `new feature request <https://github.com/NERC-CEH/isoperiod/issues>`_.
Before creating a new feature request, please check that a similar issue does not already exist.

Please describe the behavior you want and why, and provide examples of how isoperiod would be used if your feature
were added.

Contributing to the codebase
============================

We welcome any contributions to the codebase of isoperiod. That might be helping to improve documentation, adding
...
.. code-block:: bash
   ...
   pytest --cov=isoperiod --cov-report=term-missing
