...
isoperiod could always use more documentation, whether as part of the official docs, local
...
Ready to contribute? Here's how to set up isoperiod for local development.

1. Fork the isoperiod repo on GitHub.

1. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/isoperiod.git
   ```
